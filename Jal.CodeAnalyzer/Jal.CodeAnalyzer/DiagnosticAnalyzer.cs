...
namespace Jal.CodeAnalyzer
{
    ...
    public class JalCodeAnalyzerAnalyzer : DiagnosticAnalyzer
    {
        public const string DiagnosticId = "JalCodeAnalyzer";
        ...
        private void ReportDiagnostic(SyntaxNodeAnalysisContext obj)
        {
            ...
            {
                var diagnostic = Diagnostic.Create(Rule, incompleteMember.GetLocation(), 1);
